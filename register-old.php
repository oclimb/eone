    ...
    <div class="login-page-container">
        ...
        <div class="wrapper">
            <div class="form-box login">
                ...
                <form autocomplete="off" id="reg_profile" action="" method="post" class="form-horizontal">
                    ...
                    <fieldset>
                        ...
                        <div>
                            <label><a href="login.php">Already a Student</a></label>
                        </div>


                        <div>
                            <label><a href="login.php">Already a Lecturer</a></label>
                        </div>
