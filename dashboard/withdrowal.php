        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-tale">
                  <div class="card-body">
                    <p class="fs-30 mb-4">Rs <?php echo $getRefCenter['tatal_earning']; ?> </p>
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-dark-blue">
                  <div class="card-body">
                    <p class="fs-30 mb-4">Rs <?php echo $getRefCenter['available_balance'];  ?> </p>
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 mb-4">Rs <?php echo $getRefCenter['total_withdrowal'];  ?> </p>
          ...
          <!-- <div class="col-md-12 grid-margin transparent">
            <div class="row">
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 ">Rs <?php //echo $getRefCenter['direct_earning'];  
                                          ?> </p>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 ">Rs <?php //echo $getRefCenter['startaup_bonus'];  
                                          ?> </p>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 ">Rs <?php //echo $getRefCenter['team_bonus'];  
                                          ?> </p>
                  </div>
                </div>
              </div>
          ...
          <!--<div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 mb-1 stretch-card transparent">
                    <div class="card card-light-blue">
                      <div class="row">
                        <div class="card-body">
                          <p class="fs-30 "><?php //echo $getRefCenter['l3RefCount'];  
                                            ?>/3</p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 "><?php // $getRefCenter['level345'];  
                                      ?> $</p>
                  </div>
                </div>
              </div>
          ...
          <!-- <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 mb-1 stretch-card transparent">
                    <div class="card card-light-blue">
                      <div class="row">
                        <div class="card-body">
                          <p class="fs-30 "><?php //echo $getRefCenter['l6RefCount'];  
                                            ?>/6</p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 "><?php //echo $getRefCenter['level67'];  
                                      ?> $</p>
                  </div>
                </div>
              </div>
          ...
          <!-- <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 mb-1 stretch-card transparent">
                    <div class="card card-light-blue">
                      <div class="row">
                        <div class="card-body">
                          <p class="fs-30 "><?php //echo $getRefCenter['l9RefCount'];  
                                            ?>/9</p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p class="fs-30 "><?php //echo $getRefCenter['level89'];  
                                      ?> $</p>
                  </div>
                </div>
              </div>
          ...
          <div class="row" style=" margin-top: -54px;">
            <div class="col-md-12 mb-4 mb-lg-0 stretch-card transparent">
              <div class="card transparent">
                ...
                <div class="card-body">
                  <p class="mb-4"></p>
                  <p><b>Direct Sales Bonus - </b> Rs <?php echo $getRefCenter['direct_earning'];  ?></p>
            ...
            <div class="col-md-12 grid-margin transparent">
              <div class="card transparent">
                <div class="card-body">
                  ...
                  <p><span id="refcode"><?php echo $referalCode; ?></span> <button onclick="myFunction('refcode')">
                  ...
                  <p> <span id="refLink"><?php echo "https://www.eonelk.lk/register.php?ref=" . $referalCode; ?></span>
                   <button onclick="myFunction('refLink')">Copy Ref Link</button></p>
                </div>
              </div>
            </div>
              ...
              <div class="card transparent">
                <div class="card-body">
                  <div class="form-actions">
                    ...
                    //&& $currentDay == 6
                    if ($withdrawReqCount < 1 && $getRefCenter['available_balance'] >= 5000) { ?>
